(async function() {
    ...
    try {
        ...
        console.log(`Found ${workouts.length} workouts. Generating Windows Batch script...`);
        ...
        for (let i = 0; i < workouts.length; i++) {
            ...
            batScript += `mkdir "${id}" 2>nul\n`;
            batScript += `curl.exe -s -o "${id}\\${filename}" "${gpxUrl}"\n`;
            ...
            try {
                ...
                if (imageApiResponse.ok) {
                    ...
                    for (let j = 0; j < images.length; j++) {
                        ...
                        batScript += `curl.exe -s -o "${id}\\${imgFilename}" "${imgUrl}"\n`;
                    }
                }
            } catch (e) {
        ...
        console.log("=========================================");
        console.log("WINDOWS BATCH SCRIPT");
        console.log("Save in Notepad as: download.bat (Double click to run)");
        console.log("=========================================");
